...
void CShader::CreateShaderResourceViews(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, CTexture *pTexture, UINT nRootParameterStartIndex, bool bAutoIncrement)
{
	...
	pTexture->SetRootArgument(nRootParameterStartIndex, d3dSrvGPUDescriptorHandle);
}
...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSPlayer", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CPlayerShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSPlayer", "ps_5_1", ppd3dShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSTextured", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CTexturedShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSTextured", "ps_5_1", ppd3dShaderBlob));
}
...
void CObjectsShader::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, void *pContext)
{
	...
	CTexture *pTexture = new CTexture(1, 0);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, (WCHAR*)L"Image/Lava(Diffuse).dds", RESOURCE_TEXTURE2D, DXGI_FORMAT_R8G8B8A8_UNORM, 0);
//	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/Lava(Emissive).dds", RESOURCE_TEXTURE2D, DXGI_FORMAT_R8G8B8A8_UNORM, 0);
...
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "VSTerrain", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CTerrainShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile((WCHAR*)L"Shaders.hlsl", "PSTerrain", "ps_5_1", ppd3dShaderBlob));
}
